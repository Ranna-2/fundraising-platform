...
const DetailsBar = () => {
  return (
    <DetailsBarWrapper>
      ...
      <div>
        <ContactsWrapper href="tel:+94766665629">
          <Icon.Phone size={15} color="rgb(255, 255, 255)" />
          <ContactText>+94766665629</ContactText>
        </ContactsWrapper>

        <ContactsWrapper href="mailto:Kindledhope@gmail.com">
          <Icon.Mail size={15} color="rgb(255, 255, 255)" />
          <ContactText>Kindledhope@gmail.com</ContactText>
        </ContactsWrapper>
      </div>
