...
// Fetch campaign and donation data for 'Education'
$sql = "
    SELECT 
    ...
    WHERE campaigns.campaign_type = 'Education'
...
<body>
    ...
    <div class="content">
        <header>
            ...
            <p>Empowering individuals through accessible and quality education worldwide.</p>
        </header>
