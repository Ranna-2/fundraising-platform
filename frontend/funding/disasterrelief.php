...
// Fetch campaign and donation data for 'Disaster Relief'
$sql = "
    SELECT 
    ...
    WHERE campaigns.campaign_type = 'Disaster Relief'
...
<head>
    ...
    <title>Disaster Relief Programs</title>
...
<body>
    ...
    <div class="sidenav">
        ...
        <a href="hunger_relief.php"><i class="fas fa-utensils"></i> Hunger Relief</a>
        <a href="clean_water.php"><i class="fas fa-water"></i> Clean Water</a>
        <a href="disaster_relief.php"><i class="fas fa-hands-helping"></i> Disaster Relief</a>
        <a href="mental_health.php"><i class="fas fa-brain"></i> Mental Health</a>
    ...
    <div class="content">
        <header>
            <h1>Disaster Relief Programs</h1>
            <p>Help us provide immediate relief to communities affected by natural disasters worldwide.</p>
        </header>
